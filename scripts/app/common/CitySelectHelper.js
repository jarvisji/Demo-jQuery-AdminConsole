...
var Province = ["北京市", "天津市", "河北省", "山西省", "内蒙古", "辽宁省", "吉林省", "黑龙江省", "上海市", "江苏省", "浙江省", "安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "广东省", "广西省", "海南省", "重庆市", "四川省", "贵州省", "云南省", "西藏", "陕西省", "甘肃省", "青海省", "宁夏", "新疆", "港澳台"];

var CityNext = {
	"北京市" : ["东城区", "西城区", "崇文区", "宣武区", "朝阳区", "海淀区", "丰台区", "石景山区", "通州区", "平谷区", "顺义区", "怀柔区", "昌平区", "门头沟区", "房山区", "大兴区", "密云县", "延庆县", "其他"],
	"天津市" : ["和平区", "河东区", "河西区", "南开区", "河北区", "红桥区", "塘沽区", "汉沽区", "大港区", "东丽区", "西青区", "津南区", "北辰区 ", "武清区", "宝坻区", "蓟县", "宁河县", "静海县", "其他"],
	"河北省" : ["石家庄市", "邯郸市", "保定市", "承德市", "唐山市", "廊坊市", "沧州市", "衡水市", "邢台市", "秦皇岛市", "张家口"],
	"山西省" : ["太原市", "大同市", "运城市", "临汾市", "阳泉市", "长治市", "晋城市", "朔州市", "晋中市", "忻州市", "吕梁市", "其他"],
	"内蒙古" : ["呼和浩特市", "包头市", "鄂尔多斯市", "巴彦淖尔市", "乌兰察布市", "锡林郭勒盟", "呼伦贝尔市", "兴安盟", "乌海市", "赤峰市", "通辽市", "阿拉善盟", "其他"],
	"辽宁省" : ["沈阳市", "大连市", "鞍山市", "抚顺市", "本溪市", "丹东市", "锦州市", "葫芦岛市", "营口市", "盘锦市", "阜新市", "辽阳市", "朝阳市", "铁岭市", "其他"],
	"吉林省" : ["长春市", "吉林市", "四平市", "辽源市", "通化市", "白山市", "松原市", "白城市", "延边朝鲜族自治州", "其他"],
	"黑龙江省" : ["哈尔滨市", "齐齐哈尔市", "鹤岗市", "双鸭山市", "鸡西市", "大庆市", "伊春市", "牡丹江市", "佳木斯市", "七台河市", "黑河市", "绥化市", "大兴安岭地区", "其他"],
	"上海市" : ["黄浦区　", "卢湾区", "徐汇区", "长宁区", "静安区", "普陀区", "闸北区", "虹口区", "杨浦区", "浦东新区", "闵行区", "宝山区", "金山区", "松江区", "青浦区", "南汇区", "奉贤区", "崇明县", "其他"],
	"江苏省" : ["南京市", "镇江市", "常州市", "无锡市", "苏州市", "连云港市", "盐城市", "南通市", "徐州市", "宿迁市", "淮安市", "扬州市", "泰州市", "其他"],
	"浙江省" : ["杭州市", "宁波市", "温州市", "嘉兴市", "湖州市", "绍兴市", "金华市", "衢州市", "舟山市", "台州市", "丽水市", "其他"],
	"安徽省" : ["合肥市", "芜湖市", "马鞍山市", "黄山市", "宣城市", "池州市", "阜阳市", "蚌埠市", "淮南市", "淮北市", "安庆市", "亳州市", "滁州市", "六安市", "铜陵市", "宿州", "其他"],
	"福建省" : ["福州市", "厦门市", "泉州市", "莆田市", "三明市", "漳州市", "南平市", "龙岩市", "宁德市", "其他"],
	"江西省" : ["南昌市", "九江市", "景德镇市", "萍乡市", "新余市", "鹰潭市", "赣州市", "宜春市", "上饶市", "吉安市", "抚州市", "其他"],
	"山东省" : ["济南市", "青岛市", "淄博市", "枣庄市", "东营市", "烟台市", "潍坊市", "济宁市", "泰安市", "日照市", "威海市", "莱芜市", "临沂市", "德州市", "聊城市", "滨州市", "菏泽市", "其他"],
	...
	"海南省" : ['海口市', '三亚市'],
	"重庆市" : ['重庆市', '市辖区', '万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '万盛区', '双桥区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '下辖县', '綦江县', '潼南县', '铜梁县', '大足县', '荣昌县', '璧山县', '梁平县', '城口县', '丰都县', '垫江县', '武隆县', '忠县', '开县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县'],
	...
	"新疆" : ['乌鲁木齐市', '克拉玛依市', '吐鲁番地区', '哈密地区', '昌吉回族自治州', '博尔塔拉蒙古自治州', '巴音郭楞蒙古自治州', '阿克苏地区', '克孜勒苏柯尔克孜自治州', '喀什地区', '和田地区', '伊犁哈萨克自治州', '塔城地区', '阿勒泰地区', '自治区直辖县'],
	"港澳台":["香港","澳门","台湾"]
};
...
var County = {
	"河北省" : {
		...
		"张家口" : ['市辖区', '桥东区', '桥西区', '宣化区', '下花园区', '宣化县', '张北县', '康保县', '沽源县', '尚义县', '蔚县', '阳原县', '怀安县', '万全县', '怀来县', '涿鹿县', '赤城县', '崇礼县'],
	...
	"山东省" : {
		...
		"青岛市" : ['市辖区', '市南区', '市北区', '四方区', '黄岛区', '崂山区', '李沧区', '城阳区', '胶州市', '即墨市', '平度市', '胶南市'],
		...
		"菏泽市" : ['菏泽市', '市辖区', '牡丹区', '曹县', '单县', '成武县', '巨野县', '郓城县', '鄄城县', '定陶县', '东明县'],
	},
	"河南省" : {
	...
	"湖北省" : {
		...
		"襄阳市" : ['市辖区', '襄城区', '樊城区', '襄阳区', '南漳县', '谷城县', '保康县', '老河口市', '枣阳市', '宜城市'],
	...
	"甘肃省" : {
		...
		'酒泉市' : ['市辖区', '肃州区', '金塔县', '瓜州县', '肃北蒙古族自治县', '阿克塞哈萨克族自治县', '玉门市'],
...
function setSelectProvince(id) {
	for (value in Province ) {
		var html = '<option class="Province"   value="' + Province[value] + '" >' + Province[value] + '  </option>';
		$(id).append(html);
	}
}


function listData(theclass,data,id){
	for (value in data) {
			var html = '<option class="'+theclass+'"   value="' + data[value] + '" >' + data[value] + '  </option>';
			$(id).append(html);
		}
}


function setSelectCity(id, v) {
	$(id).html("");
	if (v == "") {
		var html = '<option class="City"   value="">--请城市区域--</option>';
		$(id).html(html);
	} else {
		var html = '<option  class="City"  value="">--请城市区域--</option>';
		$(id).append(html);
		listData("City",CityNext[v],id);
	}
}

function setSelectArea(id, p, v) {
	$(id).html("");
	if (v == "") {
		var html = '<option  class="Area"  value="">--请选择区域--</option>';
		$(id).html(html);
	} else {
		if(typeof County[p]!="undefined"){
			listData("Area",County[p][v],id);
		}
	}
}

function getProvince(id) {
	var Provinc = document.getElementById(id).value;
	return Provinc;
}

function CountyHide(id, v) {
	switch(v) {
		case"北京市":
			$(id).hide();
			break;

...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL+"umeditor/php/imageUp.php"             //图片上传提交地址
        ,imagePath:URL + "umeditor/php/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,toolbar:[
            ...
            'emotion image horizontal | fontsize link unlink '
        ]

...
//                }
    ...
    var Upload = {
        ...
        config: function (sel) {
            ...
            // set type=ajax, so freecoder upload php will return json data instead of iframe. By JiTing, 20140725.
    ...
    UM.registerWidget('image', {
        ...
        initContent: function (editor, $dialog) {
            var lang = editor.getLang('image')["static"],
                opt = $.extend({}, lang, {
                    image_url: UMEDITOR_CONFIG.UMEDITOR_HOME_URL + 'umeditor/dialogs/image/'
                });

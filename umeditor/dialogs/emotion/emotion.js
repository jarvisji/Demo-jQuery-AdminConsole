(function(){
    ...
    var editor = null;
    var emotionLocalization=false;
    var editTpl="<link type=\"text/css\" rel=\"stylesheet\" href=\"<%=emotion_url%>emotion.css\">" +
            ...
            "</div>";
      var thetabNum=7;
      var theSmilmgName={ 'edui-emotion-Jtab0':['j_00', 84], 'edui-emotion-Jtab1':['t_00', 40], 'edui-emotion-Jtab2':['w_00', 52], 'edui-emotion-Jtab3':['B_00', 63], 'edui-emotion-Jtab4':['C_00', 20], 'edui-emotion-Jtab5':['i_f', 50], 'edui-emotion-Jtab6':['y_00', 40] }; //图片前缀名
      var theimageFolders={ 'edui-emotion-Jtab0':'jx2/', 'edui-emotion-Jtab1':'tsj/', 'edui-emotion-Jtab2':'ldw/', 'edui-emotion-Jtab3':'bobo/', 'edui-emotion-Jtab4':'babycat/', 'edui-emotion-Jtab5':'face/', 'edui-emotion-Jtab6':'youa/'}; //图片对应文件夹路径
      var theimageCss={'edui-emotion-Jtab0':'jd', 'edui-emotion-Jtab1':'tsj', 'edui-emotion-Jtab2':'ldw', 'edui-emotion-Jtab3':'bb', 'edui-emotion-Jtab4':'cat', 'edui-emotion-Jtab5':'pp', 'edui-emotion-Jtab6':'youa'}; //图片css类名
      var theimageCssOffset={'edui-emotion-Jtab0':35, 'edui-emotion-Jtab1':35, 'edui-emotion-Jtab2':35, 'edui-emotion-Jtab3':35, 'edui-emotion-Jtab4':35, 'edui-emotion-Jtab5':25, 'edui-emotion-Jtab6':35}; //图片偏移
      var theSmileyInfor={
    ...
    if(UM.registerWidget.weixin){
    	editTpl="<link type=\"text/css\" rel=\"stylesheet\" href=\"<%=emotion_url%>emotion.css\">" +
            "<div class=\"edui-emotion-tab-Jpanel edui-emotion-wrapper\">" +
            "<ul class=\"edui-emotion-Jtabnav edui-tab-nav\">" +
            "<li class=\"edui-tab-item\"><a data-context=\".edui-emotion-Jtab0\" hideFocus=\"true\" class=\"edui-tab-text\">微信表情</a></li>" +
            "<li class=\"edui-emotion-tabs\"></li>" +
            "</ul>" +
            "<div class=\"edui-tab-content edui-emotion-JtabBodys\">" +
            "<div class=\"edui-emotion-Jtab0 edui-tab-pane\"></div>" +
            ...
            "</div>";
       thetabNum=1;
       theSmilmgName={'edui-emotion-Jtab0':['', 104] }; //图片前缀名
       theimageFolders={'edui-emotion-Jtab0':'weixin/'}; //图片对应文件夹路径
       theimageCss={'edui-emotion-Jtab0':'wx'}; //图片css类名
       theimageCssOffset={'edui-emotion-Jtab0':24}; //图片偏移
       theSmileyInfor={
                'edui-emotion-Jtab0':['微笑', '撇嘴', '色','发呆', '得意', '流泪', '害羞', '闭嘴', '睡', '大哭', '尴尬', '发怒', '调皮', '呲牙', '惊讶', '难过', '酷', '冷汗', '抓狂', '吐', '偷笑', '可爱', '白眼', '傲慢', '饥饿', '困', '惊恐','流汗','憨笑', '大兵', '奋斗', '咒骂', '疑问', '嘘', '晕', '折磨', '衰', '骷髅', '敲打', '再见','擦汗','抠鼻','鼓掌','糗大了','坏笑','左哼哼','右哼哼','哈欠','鄙视','委屈','快哭了','阴险','亲亲','吓','可怜','菜刀','西瓜','啤酒','篮球','乒乓球','咖啡','饭','猪头','玫瑰','凋谢','示爱','爱心','心碎','蛋糕','闪电','炸弹','刀','足球','瓢虫','便便','月亮','太阳','礼物','拥抱','强','弱','握手','胜利','抱拳','勾引','拳头','差劲','爱你','NO','OK','爱情','飞吻','跳跳'
    ...
    UM.registerWidget('emotion',{
        ...
        sourceData: {
            emotion: {
                tabNum:thetabNum, //切换面板数量
                SmilmgName:theSmilmgName,//图片前缀名
                imageFolders:theimageFolders,//图片对应文件夹路径
                imageCss:theimageCss,  //图片css类名
                imageCssOffset:theimageCssOffset, //图片偏移
                SmileyInfor:theSmileyInfor
            }
        },
        initContent:function( _editor, $widget ){
           console.log(UMEDITOR_CONFIG.UMEDITOR_HOME_URL.replace("/scripts/lib",""));
            var me = this,
                emotion = me.sourceData.emotion,
                lang = _editor.getLang( 'emotion' )['static'], 
                
                emotionUrl = UMEDITOR_CONFIG.UMEDITOR_HOME_URL.replace("/scripts/lib","")+ 'umeditor/dialogs/emotion/',
                options = $.extend( {}, lang, {
